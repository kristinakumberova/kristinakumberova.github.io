...
| 6 | **IA + design tokens** | UX Designer | Handover Artifact | 6 sekcí (Hero → Profile → AI Portfolio → Experience → Projects → Education) + Contact footer, AI Portfolio tree (3 nodes + tabs panel), mobile-first wireframe, Tailwind config (7 barev, 2 fonty, max-width 896 px) |
